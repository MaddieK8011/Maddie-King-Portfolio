...
void initialize() {
    (*(volatile unsigned short *)0x4000000) = 0 | (1 << 9) | (1 << 10) | (1 << 11) | (1 << 12);
    (*(volatile unsigned short *)0x400000E) = ((1) << 2) | ((29) << 8) | (0 << 7) | (0 << 14);
    (*(volatile unsigned short *)0x400000A) = ((2) << 2) | ((30) << 8) | (0 << 7) | (0 << 14);
    (*(volatile unsigned short *)0x400000C) = ((3) << 2) | ((31) << 8) | (0 << 7) | (0 << 14);
